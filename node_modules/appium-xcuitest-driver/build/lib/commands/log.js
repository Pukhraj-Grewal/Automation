...
exports.default = {
    ...
    async startLogCapture() {
        ...
        if (lodash_1.default.isUndefined(this.logs.syslog)) {
            [this.logs.crashlog,] = this.assignBiDiLogListener(new ios_crash_log_1.IOSCrashLog({
            ...
            [this.logs.syslog,] = this.assignBiDiLogListener(this.isRealDevice()
            ...
            if (lodash_1.default.isBoolean(this.opts.showSafariConsoleLog)) {
                [this.logs.safariConsole,] = this.assignBiDiLogListener(new safari_console_log_1.default({
            ...
            if (lodash_1.default.isBoolean(this.opts.showSafariNetworkLog)) {
                [this.logs.safariNetwork,] = this.assignBiDiLogListener(new safari_network_log_1.default({
